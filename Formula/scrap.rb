class Scrap < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/zachanderson/scrap/releases/download/v0.0.2/scrap-macos-arm64.tar.gz"
      sha256 "5b795abac4f1c51790505b4711b6ca705340ec385121fdf60b6701e0ef30f4e8"
    else
      url "https://github.com/zachanderson/scrap/releases/download/v0.0.2/scrap-macos-x86_64.tar.gz"
      sha256 "e1ff62f3228fe728ee09912792e85ce2a42b0c906e528b1ad58a88add03e402c"
    end
  end

  on_linux do
    url "https://github.com/zachanderson/scrap/releases/download/v0.0.2/scrap-linux-x86_64.tar.gz"
